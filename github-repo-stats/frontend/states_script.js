document.addEventListener("DOMContentLoaded", () => {
  ...
  const owner = params.get("owner") ? JSON.parse(params.get("owner")) : null;
  ...
  const ownerHTML = owner
    ? `
        <div class="owner-section">
          <img class="owner-avatar" src="${owner.avatar}" alt="Owner Avatar" />
          <a class="owner-profile" href="${owner.profile}" target="_blank">View Profile</a>
        </div>
      `
    : "";

  document.getElementById("repo-summary").innerHTML = summaryHTML + ownerHTML;
